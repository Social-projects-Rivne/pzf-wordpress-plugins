...
?>
<?php
$extra = array('startDateFormated' => date_i18n($date_format, strtotime($post->EventStartDate)),
				'startTimeFormated' => $start_time,
				'endTimeFormated' => $end_time,
				'timeRangeSeparator' => $time_range_separator,
				'readMore' => get_permalink($post->ID),
				'readMoreText' => __('Read more', 'vh'));

?>
<div id="tribe-events-event-<?php echo $event_id ?>" class="<?php tribe_events_event_classes() ?>" data-tribejson='<?php echo tribe_events_template_data( $post, $extra ); ?>'>
