...
if ( $type == 'nivo' ) {
    ...
    $slides_wrap_start = '<div class="nivoSlider shadows">';
    $slides_wrap_end = '</div>';
} else if ( $type == 'flexslider' || $type == 'flexslider_fade' || $type == 'flexslider_slide' || $type == 'fading' ) {
    $el_start = '<li>';
    $el_end = '</li>';
    $slides_wrap_start = '<ul class="slides shadows">';
    $slides_wrap_end = '</ul>';
    ...
    $el_start = '<li class="isotope-item shadows">';
    $el_end = '</li>';
...
foreach ( $images as $attach_id ) {
    ...
    if ($attach_id > 0) {
        ...
        $post_thumbnail['thumbnail'] = '<img src="'.$this->assetUrl('vc/no_image.png').'" alt=""/>';
