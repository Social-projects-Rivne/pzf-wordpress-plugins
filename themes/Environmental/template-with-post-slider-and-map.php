<?php
/**
 * Template Name: With post slider and map
 */
get_header();
...
(function() {
	...
	var secheltLoc = new google.maps.LatLng(<?php echo $vh_map_lat; ?>, <?php echo $vh_map_long; ?>);
		...
		var myOptions = {
			...
			,maxWidth: 0
			,pixelOffset: new google.maps.Size(-15, 150)
			,zIndex: null
			,alignBottom: true
			,boxStyle: {
				background: ""
		...
		// ib.setContent('<div class="infobox"><div class="infobox-content"><div class="map_contact"><?php echo $contact_us; ?></div><div><span class="map_phone icon-mobile"><?php echo $vh_map_phone; ?></span><span class="map_email icon-mail-alt"><a href="mailto:<?php echo $vh_map_email; ?>" target="_top"><?php echo $vh_map_email; ?></a></span><span class="map_address icon-location-1"><?php echo $vh_map_address; ?></span><div class="clearfix"></div><a href="https://www.google.com/maps/dir//' + <?php echo $vh_map_lat; ?>  + ',' + <?php echo $vh_map_long; ?>  + '/@' + <?php echo $vh_map_lat; ?>  + ',' + <?php echo $vh_map_long; ?>  + ',15z" class="map_directions wpb_button wpb_btn-transparent"><?php echo $directions; ?></a></div><div class="clearfix"></div></div></div>');
