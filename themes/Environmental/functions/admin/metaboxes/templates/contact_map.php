...
<div class="row-container">
	<div class="content google_map_admin">
		...
		<input type="text" name="vh_map_address" value="<?php echo $vh_map_address; ?>" size="55" /><br />

		<label><?php _e('Phone:', 'vh'); ?></label>
		<input type="text" name="vh_map_phone" value="<?php echo $vh_map_phone; ?>" size="55" /><br />

		<label><?php _e('Email:', 'vh'); ?></label>
		<input type="text" name="vh_map_email" value="<?php echo $vh_map_email; ?>" size="55" /><br />

		<label><?php _e('Latitude:', 'vh'); ?></label>
		<input type="text" name="vh_map_lat" value="<?php echo $vh_map_lat; ?>" size="55" /><br />

		<label><?php _e('Longitude:', 'vh'); ?></label>
		<input type="text" name="vh_map_long" value="<?php echo $vh_map_long; ?>" size="55" /><br />
	</div>
</div>