...
if (!function_exists('of_options')) {
	...
	function of_options() {
		...
		// Payment gateway used for projects
		$payment_gateway = array('PayPal');
		...
		// Slider effect array
		$slider_effect = array('random', 'swirl', 'rain', 'straight');
		...
		$vh_fonts_default_options = array(
			'vh_primary_font_dark_font_face'   => 'Roboto',
			...
			'vh_sidebar_font_dark_font_face'   => 'Roboto',
		...
		$options[] = array(
			"name"  => "Post slider categories",
			"desc"  => "Post categories to show at the slider.",
			"id"    => SHORTNAME . "_slider_categories",
			"order" => "",
			"type"  => "text");

		$options[] = array(
			"name"  => "Post slider auto play",
			"desc"  => "Should post slider auto play when page loads? true/false/time im ms",
			"id"    => SHORTNAME . "_slider_auto",
			"order" => "",
			"type"  => "text");

		$options[] = array(
			"name"  => "Post slider speed",
			"desc"  => "Animation speed for post slider. Time in ms",
			"id"    => SHORTNAME . "_slider_aspeed",
			"order" => "",
			"type"  => "text");
		...
		$options[] = array(
			"name"    => "Payment gateway",
			"desc"    => "Please select which payment gateway you would like to use for projects donations.",
		...
		$options[] = array(
			...
			"order" => "&copy; [year], Environmental by <a href='http://cohhe.com'>Cohhe</a>",
			"type"  => "text");
